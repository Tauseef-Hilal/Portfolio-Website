  ...
  return (
    <nav className="fixed top-0 w-full z-30 border-b border-gray-800/60 bg-gradient-to-b from-black/95 to-black/80 backdrop-blur-md">
      <div className="relative max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        >
          {/* Desktop Text */}
          <span className="hidden sm:inline-flex items-center gap-2 text-xs uppercase tracking-wider font-semibold px-4 py-2 border border-gray-700 bg-white/5 backdrop-blur-sm hover:border-gray-400 hover:bg-white/10 transition-all duration-300">
            Resume
            <FiDownload className="text-sm transition-transform duration-300 group-hover:translate-y-[2px]" />
          </span>

          {/* Mobile Icon */}
          <span className="sm:hidden border border-gray-700 p-2 bg-white/5 hover:bg-white/10 hover:border-gray-400 transition-all duration-300">

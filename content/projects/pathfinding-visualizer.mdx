export const meta = {
  ...
  shortDescription:
    "Interactive visualization tool for popular pathfinding algorithms.",
  tech: ["Python", "Pygame"],
  githubUrl: "https://github.com/Tauseef-Hilal/Pathfinding-Visualizer",
  liveUrl: "",
  imagePath: "/images/pathfinder.png",
  featured: false,
  year: 2023,
  role: "Developer",
  status: "Archived",
  highlights: [
    "Programmed an interactive, educational visualizer illustrating 8+ pathfinding algorithms in Python and Pygame.",
    "Accumulated 230+ GitHub stars and 33+ forks following public repository release.",
  ],
};
